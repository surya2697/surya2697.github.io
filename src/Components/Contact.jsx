        ...
        >
          ...
          >
            ...
            <HStack gap={"10px"}>
              <HiLocationMarker />
              <Text textAlign={"left"}>
               Vijay Nagar devlali camp,
                <br /> Nasik, Maharashtra. India
              </Text>
            </HStack>
            <HStack gap={"10px"}>
              <BsFillTelephoneFill />
              <Text>+91 8698080956</Text>
            </HStack>
            <HStack gap={"10px"}>
              <MdEmail />
              <Text>suryaahire97@gmail.com</Text>
            </HStack>
            <HStack>
              <Box _hover={{ color: "#0A66C2", cursor: "pointer" }}>
                <Link
                  href="https://www.linkedin.com/in/surya-ahire-36541819b/"
                  target={"_blank"}
                >
              ...
              <Box _hover={{ color: "#6e5494", cursor: "pointer" }}>
                <Link href="https://github.com/surya2697" target={"_blank"}>
                  <AiFillGithub size="25px" />
                </Link>
              </Box>
              <Box _hover={{ color: "#F56040", cursor: "pointer" }}>
                <Link
                  href="https://www.instagram.com/suryaahire97/"
                  target={"_blank"}
                >
