...
export function Home() {
  function handleClick(){
    window.open('https://drive.google.com/file/d/1T_ocjvEAxARtQIEwbYEs4TIvzEmFZ3H1/view?usp=share_link','_blank')
  }
  return (
    <>
      <Box className="home">
        ...
        >
          ...
          >
            ...
            <HStack>
              ...
              <Button><a href={download} download="Surya_Ahire_Resume"><FaCloudDownloadAlt/></a></Button>
            </HStack>
          </VStack>
          <Box>
            <Image
